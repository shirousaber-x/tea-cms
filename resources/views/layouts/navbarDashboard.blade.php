...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light mb-5">
        <div class="container-fluid">
            <a class="navbar-brand" href="/"><img src="/img/Ahmad_Tea_logo.png" style="width: 100px"></a>
            <!--Logo picture-->
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    <li class="nav-item">
                        <a class="nav-link {{ ($title === "Manage User") ? 'active' : '' }}" href="/manage_user">Manage User</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link {{ ($title === "Manage Product") ? 'active' : '' }}" href="/manage_product">Manage Product</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link {{ ($title === "Manage Contact") ? 'active' : '' }}" href="/contactform/all">Manage Contact</a>
                    </li>
                </ul>
