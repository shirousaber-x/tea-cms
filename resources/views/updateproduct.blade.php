...
<div class="container-lg px-4 h-100" id="">
    ...
    <form method="post" action="process" enctype="multipart/form-data">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" name="kd_pro" value="{{ $dtahmad->kode_product }}" readonly>
        </div>
        <br>
        <div class="form-group">
            ...
            <input type="text" class="form-control" name="nama_pro" placeholder="Masukkan Nama Barang"
                value="<?=(old('nama_pro')=='')? $dtahmad->nama_product : old('nama_pro')?>" required>
        </div>
        <br>
        <div class="form-group">
            <label class="font-weight-bold text-light">Foto Product</label>
            <input type="file" class="form-control" name="fotopro" accept=".jpg, .jpeg, .png">
        </div>
        <br>
        <div class="form-group">
            ...
            <input type="text" class="form-control" name="deskripsi" placeholder="Masukkan Deskripsi Barang"
                value="<?=(old('deskripsi')=='')? $dtahmad->deskripsi : old('deskripsi')?>" required>
        </div>
        <br>
        <div class="form-group">
